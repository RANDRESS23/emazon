...
import { EMAIL_INPUT_LABEL, EMAIL_INPUT_LABEL2, EMAIL_INPUT_NAME, EMAIL_REGEX, EMPTY_STRING, ERROR_ICON_PATH, LOGED_SUCCESSFULLY_TEXT, PASSWORD_INPUT_LABEL, PASSWORD_INPUT_LABEL2, PASSWORD_INPUT_NAME, SERVER_ERROR_TEXT, SIGN_IN_BUTTON_TEXT, SUCCESS_ICON_PATH } from '@utils/constants/general';
...
export class FormSignInComponent implements OnInit {
  ...
  moreFields: Record<string, any[]> = {
    ...
    [PASSWORD_INPUT_NAME]: [EMPTY_STRING, [Validators.required]]
  }
