...
import { EMAIL_REGEX, EMAIL_WAREHOUSE_ASSISTANT_INPUT_LABEL, EMAIL_WAREHOUSE_ASSISTANT_INPUT_LABEL2, EMAIL_WAREHOUSE_ASSISTANT_INPUT_NAME, EMPTY_STRING, ERROR_ICON_PATH, PASSWORD_REGEX, PASSWORD_WAREHOUSE_ASSISTANT_INPUT_LABEL, PASSWORD_WAREHOUSE_ASSISTANT_INPUT_LABEL2, PASSWORD_WAREHOUSE_ASSISTANT_INPUT_NAME, SERVER_ERROR_TEXT, SIGN_IN_BUTTON_TEXT, SUCCESS_ICON_PATH } from '@utils/constants/admin';
import { LOGED_SUCCESSFULLY_TEXT } from '@utils/constants/general';
