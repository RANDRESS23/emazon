...
import { ADD_WAREHOUSE_ASSISTANT_BUTTON_TEXT, BIRTHDATE_WAREHOUSE_ASSISTANT_INPUT_LABEL, BIRTHDATE_WAREHOUSE_ASSISTANT_INPUT_LABEL2, BIRTHDATE_WAREHOUSE_ASSISTANT_INPUT_NAME, DOCUMENT_WAREHOUSE_ASSISTANT_INPUT_LABEL, DOCUMENT_WAREHOUSE_ASSISTANT_INPUT_LABEL2, DOCUMENT_WAREHOUSE_ASSISTANT_INPUT_NAME, LAST_NAME_WAREHOUSE_ASSISTANT_INPUT_LABEL, LAST_NAME_WAREHOUSE_ASSISTANT_INPUT_LABEL2, LAST_NAME_WAREHOUSE_ASSISTANT_INPUT_NAME, NAME_WAREHOUSE_ASSISTANT_INPUT_LABEL, NAME_WAREHOUSE_ASSISTANT_INPUT_LABEL2, NAME_WAREHOUSE_ASSISTANT_INPUT_NAME, PHONE_WAREHOUSE_ASSISTANT_INPUT_LABEL, PHONE_WAREHOUSE_ASSISTANT_INPUT_LABEL2, PHONE_WAREHOUSE_ASSISTANT_INPUT_NAME, REGISTER_NEW_WAREHOUSE_ASSISTANT_TEXT, REGISTER_NEW_WAREHOUSE_ASSISTANT_TEXT_PRIMARY, SAVE_WAREHOUSE_ASSISTANT_BUTTON_TEXT, WAREHOUSE_ASSISTANT_SAVED_TEXT } from '@utils/constants/admin';
import { DOCUMENT_REGEX, EMAIL_INPUT_LABEL, EMAIL_INPUT_LABEL2, EMAIL_INPUT_NAME, EMAIL_REGEX, EMPTY_STRING, ERROR_ICON_PATH, NAME_REGEX, PASSWORD_INPUT_LABEL, PASSWORD_INPUT_LABEL2, PASSWORD_INPUT_NAME, PASSWORD_REGEX, PHONE_REGEX, SERVER_ERROR_TEXT, SUCCESS_ICON_PATH } from '@utils/constants/general';
