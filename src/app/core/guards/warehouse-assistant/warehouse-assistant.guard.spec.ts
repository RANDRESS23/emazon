...
import { WarehouseAssistantGuard } from './warehouse-assistant.guard';
import { AuthService } from '../../services/auth/auth.service';
import { ActivatedRouteSnapshot, Router, RouterStateSnapshot } from '@angular/router';
import { RolesEnum } from '@utils/enums/roles';

describe('WarehouseAssistantGuard', () => {
  let guard: WarehouseAssistantGuard;
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      providers: [
        WarehouseAssistantGuard,
        { provide: AuthService, useValue: authServiceMock },
        { provide: Router, useValue: routerMock },
      ],
    });

    guard = TestBed.inject(WarehouseAssistantGuard);
  ...
  it('should allow activation when user is authenticated and has AUX_BODEGA role', () => {
  ...
  it('should block activation and redirect to /login if user is authenticated but not AUX_BODEGA', () => {
    authService.isAuthenticated.mockReturnValue(true);
  ...
  it('should block activation and redirect to /login if user is ADMIN', () => {
    authService.isAuthenticated.mockReturnValue(true);
