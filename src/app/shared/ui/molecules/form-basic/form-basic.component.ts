...
import { DESCRIPTION_CATEGORY_TEXTAREA_NAME, MAX_LENGTH_FIELD_ERROR_TEXT, MIN_VALUE_FIELD_ERROR_TEXT, NAME_CATEGORY_INPUT_NAME, PATTERN_ERRORS, REQUIRED_FIELD_ERROR_TEXT } from '@utils/constants/admin';
import { CANCEL_BUTTON_TEXT, EMPTY_STRING, LOADING_BUTTON_TEXT, ZERO } from '@utils/constants/general';
